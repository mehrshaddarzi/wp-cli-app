...
use WP_CLI_APP\Package\Arguments\Admin;
use WP_CLI_APP\Package\Arguments\Core;
use WP_CLI_APP\Package\Arguments\Locale;
use WP_CLI_APP\Package\Arguments\Permalink;
use WP_CLI_APP\Utility\CLI;
use WP_CLI_APP\Config;
...
use WP_CLI_APP\Package\Arguments\Commands;
use WP_CLI_APP\Package\Arguments\Dir;
use WP_CLI_APP\Package\Arguments\Options;
use WP_CLI_APP\Package\Arguments\Plugins;
use WP_CLI_APP\Package\Arguments\Rest_API;
use WP_CLI_APP\Package\Arguments\Security;
use WP_CLI_APP\Package\Arguments\Themes;
use WP_CLI_APP\Package\Arguments\Timezone;
use WP_CLI_APP\Package\Arguments\Users;
	...
	public function sanitize_mysql( $array, $validate = false ) {
		...
		if ( is_string( $array ) ) {
			...
			if ( PHP::is_assoc_array( $array ) === false ) {
				...
				if ( isset( $array['DB_CHARSET'] ) and ! in_array( PHP::to_lower_string( $array['DB_CHARSET'] ), $GLOBALS['WP_CLI_APP']['package']['mysql_character'] ) ) {
				...
				if ( ! $valid->is_cli_error() and defined( 'WP_CLI_APP_PACKAGE_RUN_CHECK_MYSQL' ) ) {
